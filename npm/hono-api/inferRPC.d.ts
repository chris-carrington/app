 ...
 * @example
    ```
    import type { AppType } from '@src/index'
    import { createRPC, type InferJson } from '@hono-api/be'
 ...
 * @example
    ```
    import type { AppType } from '@src/index'
    import { createRPC, type InferQuery } from '@hono-api/be'
 ...
 * @example
    ```
    import type { AppType } from '@src/index'
    import { createRPC, type InferParam } from '@hono-api/be'
 ...
 * @example
    ```
    import type { AppType } from '@src/index'
    import { createRPC, type InferHeader } from '@hono-api/be'
...
* @example
  ```
  import type { AppType } from '@src/index'
  import { createRPC, type InferCookie } from '@hono-api/be'
...
* @example
  ```
  import type { AppType } from '@src/index'
  import { createRPC, type InferForm } from '@hono-api/be'
...
* @example
  ```
  import type { AppType } from '@src/index'
  import { createRPC, type InferResponse } from '@hono-api/be'
